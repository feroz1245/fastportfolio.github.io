...
class Business_Hours extends Widget_Base {
    ...
    protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#000000',
				'selectors' => [
					'{{WRAPPER}} h2.exad-business-hours-heading' => 'color: {{VALUE}};'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} h2.exad-business-hours-heading' => 'background-color: {{VALUE}};'
				]
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} h2.exad-business-hours-heading'
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'       => 'center',
				'selectors'     => [
					'{{WRAPPER}} h2.exad-business-hours-heading' => 'text-align: {{VALUE}};'
				]
			]
		);
		...
		$this->add_responsive_control(
            ...
            [
				...
				'size_units' => ['px', '%'],
				'selectors'  => [
                    '{{WRAPPER}} h2.exad-business-hours-heading' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'    => [
                    '{{WRAPPER}} h2.exad-business-hours-heading' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ]
            ]
        );
        ...
        $this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors'  => [
					'{{WRAPPER}} h2.exad-business-hours-heading'=> 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				]
			]
		);
    ...
    public function render() {
		...
		<?php
			$heading ? printf( '<h2 ' . $this->get_render_attribute_string( 'exad_business_hours_heading' ) . '>%s</h2>', wp_kses_post( $heading ) ) : '';
        ...
        #>
            <div {{{ view.getRenderAttributeString( 'businessHours' ) }}}>
            	<# if ( settings.exad_business_hours_heading ) { #>
	            	<h2 {{{ view.getRenderAttributeString( 'exad_business_hours_heading' ) }}}>
