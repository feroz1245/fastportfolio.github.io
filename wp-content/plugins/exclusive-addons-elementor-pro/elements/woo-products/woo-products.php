                            ...
                            <?php
                                ...
                                if( 'yes' == $starRating ) : ?>                           
                                    <ul class="exad-woo-product-content-rating">
                                        <div class="exad-woo-product-star-rating" title="<?php echo sprintf(__( 'Rated %s out of 5', 'woocommerce' ), $average); ?>">
                                            <span style="width:<?php echo ( ( $average / 5 ) * 100 ); ?>%"><strong itemprop="ratingValue" class="rating"><?php echo $average; ?></strong> <?php _e( 'out of 5', 'woocommerce' ); ?></span>
                                        </div>
                                    </ul>
                                <?php    
                                endif;
