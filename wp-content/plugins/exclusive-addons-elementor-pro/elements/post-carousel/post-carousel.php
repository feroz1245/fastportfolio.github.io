...
class Post_Carousel extends Widget_Base {
    ...
    protected function render() {
        ...
        $settings['post_args']     = Helper::exad_get_post_arguments( $settings, 'exad_post_carousel' );
        ...
        $this->add_render_attribute(
            ...
            [
                ...
                'data-carousel-column-tablet'   => intval( esc_attr( $settings['exad_post_carousel_per_view_tablet'] ) ),
                'data-carousel-column-mobile'   => intval( esc_attr( $settings['exad_post_carousel_per_view_mobile'] ) ),
