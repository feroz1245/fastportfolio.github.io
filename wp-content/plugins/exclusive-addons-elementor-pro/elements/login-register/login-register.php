...
class Login_Register extends Widget_Base {
    ...
    protected function render() {
        ...
        <div class="exad-login-register">
            ...
            <?php } ?>
            <form <?php echo $this->get_render_attribute_string( 'exad_login_register_form' ); ?> method="post" action="<?php echo esc_url( site_url( 'wp-login.php', 'login_post' ) ); ?>">
                ...
                <div <?php echo $this->get_render_attribute_string( 'exad_login_register_container' ); ?>>
                    ...
                    <div <?php echo $this->get_render_attribute_string( 'exad_login_register_submit_button_wrapper' ); ?>>
                        <button type="submit" <?php echo $this->get_render_attribute_string( 'exad_login_register_submit_button' ); ?>>
