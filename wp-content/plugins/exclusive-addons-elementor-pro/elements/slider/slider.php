    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
			...
			[
                ...
                'selector'  => '{{WRAPPER}} .exad-slide-content.exad-slide-content-title-background-yes h2','{{WRAPPER}} .exad-slide-content h2',
                'condition' => [
                        ...
                        <div class="exad-slide-inner">
                            <div class="exad-slide-content exad-slide-content-title-background-<?php echo esc_attr( $settings['exad_single_slider_custom_style_title_background_enable'] ); ?>">
                                <?php if( $each_slide['exad_slider_title'] ) : ?>
                                    <h2 data-animation-in="<?php echo esc_attr( $exad_title_animation_in ); ?>" data-delay-in="<?php echo esc_attr( $each_title_delay_in ); ?>" data-duration-in="<?php echo esc_attr( $each_title_duration_in ); ?>" data-animation-out="<?php echo esc_attr( $exad_title_animation_out ); ?>" data-delay-out="<?php echo esc_attr( $title_delay_out ); ?>" data-duration-out="<?php echo esc_attr( $each_title_duration_out ); ?>"><?php echo esc_html($each_slide['exad_slider_title']); ?></h2>
                                <?php endif;

                                if( $each_slide['exad_slider_details'] ) : ?>
                                    <p data-animation-in="<?php echo esc_attr( $exad_details_animation_in ); ?>" data-delay-in="<?php echo esc_attr( $each_details_delay_in ); ?>" data-duration-in="<?php echo esc_attr( $each_details_duration_in ); ?>" data-animation-out="<?php echo esc_attr( $exad_details_animation_out ); ?>" data-delay-out="<?php echo esc_attr( $details_delay_out ); ?>" data-duration-out="<?php echo esc_attr( $each_details_duration_out ); ?>"><?php echo wp_kses_post( $each_slide['exad_slider_details'] ); ?></p>
                                <?php endif;
