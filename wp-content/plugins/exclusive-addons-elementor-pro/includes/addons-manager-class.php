...
class Addons_Manager {
	...
	public static function init() {
        ...
        add_action( 'elementor/widgets/widgets_registered', [ __CLASS__, 'initiate_pro_widgets' ] );
        self::initiate_pro_extensions();

        if ( class_exists( 'woocommerce' ) ) {

            add_filter( 'exad_add_pro_widgets', [ __CLASS__, 'add_woo_pro_widgets_to_free' ] ); 
            add_action( 'elementor/widgets/widgets_registered', [ __CLASS__, 'initiate_woo_pro_widgets' ] );
