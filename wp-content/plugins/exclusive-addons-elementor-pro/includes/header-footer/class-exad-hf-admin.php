				...
				<tr class="exad-hf-options-row sticky-stacked">
					<td class="exad-hf-options-row-heading">
						<label for="sticky-header">
							<?php _e( 'Sticky Header', 'header-footer-elementor' ); ?>
						</label>
						<i class="exad-hf-options-row-heading-help dashicons dashicons-editor-help" title="<?php _e( 'Enable Sticky Header.', 'header-footer-elementor' ); ?>"></i>
					</td>
					<td class="exad-hf-options-row-content">
